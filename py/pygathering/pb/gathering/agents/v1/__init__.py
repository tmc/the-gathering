...
class AgentServiceStub(betterproto.ServiceStub):
    async def interact(
        ...
        *,
        ...
        async for response in self._stream_stream(
            "/gathering.agents.v1.AgentService/Interact",
    ...
    async def provision_agent(
        ...
        *,
        ...
        return await self._unary_unary(
            "/gathering.agents.v1.AgentService/ProvisionAgent",
...
class AgentServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/gathering.agents.v1.AgentService/Interact": grpclib.const.Handler(
                self.__rpc_interact,
            ...
            "/gathering.agents.v1.AgentService/ProvisionAgent": grpclib.const.Handler(
