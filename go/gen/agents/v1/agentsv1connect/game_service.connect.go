...
const (
	...
	GameServiceName = "agents.v1.GameService"
)
...
const (
	...
	GameServiceJoinGameProcedure = "/agents.v1.GameService/JoinGame"
)

// GameServiceClient is a client for the agents.v1.GameService service.
type GameServiceClient interface {
	JoinGame(context.Context, *connect.Request[v1.JoinGameRequest]) (*connect.Response[v1.JoinGameResponse], error)
}

// NewGameServiceClient constructs a client for the agents.v1.GameService service. By default, it
...
// JoinGame calls agents.v1.GameService.JoinGame.
...
// GameServiceHandler is an implementation of the agents.v1.GameService service.
...
func NewGameServiceHandler(svc GameServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/agents.v1.GameService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGameServiceHandler) JoinGame(context.Context, *connect.Request[v1.JoinGameRequest]) (*connect.Response[v1.JoinGameResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agents.v1.GameService.JoinGame is not implemented"))
}
