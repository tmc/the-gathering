...
const (
	...
	AgentAudioVideoServiceName = "gathering.agents.v1.AgentAudioVideoService"
)
...
const (
	...
	// Speak RPC.
	AgentAudioVideoServiceSpeakProcedure = "/gathering.agents.v1.AgentAudioVideoService/Speak"
)

// AgentAudioVideoServiceClient is a client for the gathering.agents.v1.AgentAudioVideoService
// service.
...
// NewAgentAudioVideoServiceClient constructs a client for the
// gathering.agents.v1.AgentAudioVideoService service. By default, it uses the Connect protocol with
...
// Speak calls gathering.agents.v1.AgentAudioVideoService.Speak.
...
// AgentAudioVideoServiceHandler is an implementation of the
// gathering.agents.v1.AgentAudioVideoService service.
...
func NewAgentAudioVideoServiceHandler(svc AgentAudioVideoServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gathering.agents.v1.AgentAudioVideoService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAgentAudioVideoServiceHandler) Speak(context.Context, *connect.ClientStream[v1.WordEvent]) (*connect.Response[v1.SpeakResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gathering.agents.v1.AgentAudioVideoService.Speak is not implemented"))
}
